...
export const biltyOfficialIconData: string = './bilty-official-icon.png';
export const biltyIconData: string = './bilty-official-icon.png';
export const biltyIconLegacyData: string = './bilty-icon.png';
